...
namespace ASAP_WPF
{
    internal static class ExtensionMethods
    {
        ...
        public static (Mat, Mat) SliceMatInHalf(this Mat matToSlice)
        {//https://answers.opencv.org/question/82641/dividing-image-horizontally-into-equal-parts/

            if(matToSlice.Height < 2) throw new Exception("Given matrix has 1 or no rows!");
            var upperHalfRectFirstPoint = new Point(0,0);
            var upperHalfRectSecondPoint = new Point(matToSlice.Cols, matToSlice.Height / 2);
            ...
            var lowerHalfRectSecondPoint = new Point(matToSlice.Cols, matToSlice.Height - upperHalfRect.Height);
